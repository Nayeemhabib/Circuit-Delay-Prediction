...
Accurate circuit delay estimation using SPICE simulations is computationally expensive. This project explores machine learning models to predict CMOS inverter timing parameters across voltage corners, enabling faster early-stage timing analysis.
# Problem Statement:-
...
# Tech Stack
 ...
 - Matplotlib.
# Project Structure:-
 - circuit-delay-prediction/ src/ metrics.py models.py train.py utils.py data/ data.csv results/ requirements.txt README.md
# How to Run:- 
 - pip install -r requirements.txt  
 - python src/train.py.
# ScreenShots:-
## Circuit Diagram:-
![Circuit Diagram](Circuit_Diagram.jpeg/Circuit Diagram.png)
## Result Graphs:-
![Result Graphs](Circuit_Diagram.jpeg/Circuit Diagram.png)
